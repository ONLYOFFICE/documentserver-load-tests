    ...
    window.onload = function()
    {
        ...
        xhr.onload = function()
        {
            ...
            if (xhr.status == 200 || (xhr.status == 0 && xhr.readyState == 4))
            {
                ...
                // extend window.Asc.background_for_plugins object
